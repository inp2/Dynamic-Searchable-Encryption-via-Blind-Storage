 ...
 */
public class SqlDatabaseConnectLarge extends SQLiteOpenHelper {
    //The Android's default system path of your application database.
    private static String DB_PATH = "/data/data/edu.CS463.mp3.app/databases/";
    private static String DB_NAME = "large_map.db";
     ...
     * @param context
     */
    public SqlDatabaseConnectLarge(Context context) {
    ...
    public Cursor getLargeDocumentIDs(String keyword) {
        String myPath = DB_PATH + DB_NAME;

        //  myData = SQLiteDatabase.openDatabase(myPath, null, SQLiteDatabase.OPEN_READWRITE);
        File file = new File("/data/data/edu.CS463.mp3.app/databases/large_map.db");
